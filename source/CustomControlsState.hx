...
class CustomControlsState extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		// bg
		var funibg:FlxSprite = new FlxSprite(-80).loadGraphic('assets/images/menuBG.png');
		funibg.scrollFactor.x = 0;
		funibg.scrollFactor.y = 0.18;
		funibg.setGraphicSize(Std.int(funibg.width * 1.1));
		funibg.updateHitbox();
		funibg.screenCenter();
		funibg.antialiasing = true;
