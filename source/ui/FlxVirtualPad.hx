...
class FlxVirtualPad extends FlxSpriteGroup
{
	...
	public function new(?DPad:FlxDPadMode, ?Action:FlxActionMode)
	{
		...
		switch (Action)
		{
			...
			case PAUSEB:
				actions.add(add(buttonPause = createButton(0, 0, 44 * 3, 45 * 3, "pause")));
			case A_B_C:
			...
			case A_B_C_UP_DOWN:
				...
				actions.add(add(buttonB = createButton(FlxG.width - 86 * 3, FlxG.height - 45 * 3, 44 * 3, 45 * 3, "b")));
				actions.add(add(buttonC = createButton(FlxG.width - 44 * 3, FlxG.height - 45 * 3, 44 * 3, 45 * 3, "c")));
				actions.add(add(buttonUp = createButton(0, FlxG.height - 85 * 3, 44 * 3, 45 * 3, "up")));
				actions.add(add(buttonDown = createButton(0, FlxG.height - 45 * 3, 44 * 3, 45 * 3, "down")));
			case A_B_X_Y:
